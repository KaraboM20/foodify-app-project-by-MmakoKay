...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        ...
        // Dinner
        { name: "BBQ Burger", ingredients: ["bun", "beef patty", "bbq sauce", "onion", "cheese"], instructions: "Grill beef patty, brush with BBQ sauce, add onion and cheese on bun.", image: "https://realfoodbydad.com/wp-content/uploads/2019/07/Southern-BBQ-Burger-Real-Food-by-Dad-683x1024.jpg" },
