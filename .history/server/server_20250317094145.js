...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        ...
        { name: "Sweet Toast", category: "dessert", ingredients: ["bread", "butter", "cinnamon", "sugar", "honey"], instructions: "Butter bread, sprinkle with cinnamon and sugar, toast, drizzle with honey.", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRI8N1_DFTMwWW0zFLqu8I2E98Ydg633KmDAg&s", category: "dessert" },
        ...
        { name: "Chocolate Toast", category: "dessert", ingredients: ["bread", "chocolate spread", "banana", "whipped cream"], instructions: "Spread chocolate on toast, top with banana slices and whipped cream.", image: "https://www.tasteofhome.com/wp-content/uploads/2018/01/Chocolate-French-Toast_EXPS_CMZ18_8306_B10_26_6b.jpg", category: "dessert" }
      ];
