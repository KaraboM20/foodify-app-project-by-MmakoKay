...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        ...
        { name: "Pepperoni Pizza", category: "lunch",ingredient: ["pizza dough", "tomato sauce", "pepperoni", "cheese", "oregano"], instructions: "Spread sauce on dough, add pepperoni and cheese, sprinkle oregano, bake at 425°F for 20 mins.", image: "https://www.cobsbread.com/us/wp-content//uploads/2022/09/Pepperoni-pizza-850x630-1.png", category: "lunch" },
        { name: "Turkey Sandwich", category: "lunch",ingredient: ["bread", "turkey", "lettuce", "cheese", "mustard"], instructions: "Layer turkey, lettuce, and cheese on bread, spread mustard, serve cold or grilled.", image: "https://www.eatingonadime.com/wp-content/uploads/2022/03/eod-turkey-sandwich-5-2.jpg", category: "lunch" },
        { name: "Cheese Toast", category: "lunch",ingredient: ["bread", "cheese", "butter", "garlic", "parsley"], instructions: "Butter bread, add cheese and garlic, bake at 375°F until melted, sprinkle parsley.", image: "https://cdn.loveandlemons.com/wp-content/uploads/2023/01/grilled-cheese-500x500.jpg", category: "lunch" },
        { name: "Veggie Burger", category: "lunch",ingredient: ["bun", "veggie patty", "lettuce", "tomato", "ketchup"], instructions: "Cook veggie patty, assemble on bun with lettuce, tomato, and ketchup.", image: "https://biancazapatka.com/wp-content/uploads/2020/05/veganer-bohnen-burger.jpg", category: "lunch" },
        // Dinner
