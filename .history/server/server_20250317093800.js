...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        ...
        {name: "Breakfast Pizza", category: "breakfast", ingredients: ["pizza dough", "egg", "sausage", "cheese", "spinach"], instructions: "Spread dough, top with scrambled egg, sausage, cheese, and spinach, bake at 400°F for 15 mins.", image: "https://www.skinnytaste.com/wp-content/uploads/2018/02/breakfast-pizza-1-6.jpg", category: "breakfast",},
        {name: "Breakfast Sandwich", category: "breakfast", ingredients: ["bread", "egg", "ham", "cheese", "butter"], instructions: "Fry egg, layer with ham and cheese between buttered bread, grill until golden.", image: "https://grilledcheesesocial.com/wp-content/uploads/2024/04/bagel-breakfast-sandwich-recipe-9.jpg", category: "breakfast", },
        {name: "Breakfast Toast", category: "breakfast", ingredients: ["bread", "avocado", "egg", "salt", "pepper"], instructions: "Toast bread, mash avocado on top, add fried egg, season with salt and pepper.", image: "https://www.aberdeenskitchen.com/wp-content/uploads/2019/05/Avocado-Egg-Breakfast-Toast-FI-Thumbnail-1200X1200.jpg", category: "breakfast", },
        ...
        // Lunch
        { name: "Chicken Burger", category: "lunch",ingredient: ["bun", "chicken patty", "lettuce", "tomato", "mayo"], instructions: "Grill chicken patty, assemble on bun with lettuce, tomato, and mayo.", image: "https://i.ytimg.com/vi/L5Z3mO5SqJs/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDXIjGEsLrH8ZKQmhoiqH6d25b9qg" },
        { name: "Pepperoni Pizza", category: "lunch",ingredient: ["pizza dough", "tomato sauce", "pepperoni", "cheese", "oregano"], instructions: "Spread sauce on dough, add pepperoni and cheese, sprinkle oregano, bake at 425°F for 20 mins.", image: "https://www.cobsbread.com/us/wp-content//uploads/2022/09/Pepperoni-pizza-850x630-1.png" },
        { name: "Turkey Sandwich", category: "lunch",ingredient: ["bread", "turkey", "lettuce", "cheese", "mustard"], instructions: "Layer turkey, lettuce, and cheese on bread, spread mustard, serve cold or grilled.", image: "https://www.eatingonadime.com/wp-content/uploads/2022/03/eod-turkey-sandwich-5-2.jpg" },
        { name: "Cheese Toast", category: "lunch",ingredient: ["bread", "cheese", "butter", "garlic", "parsley"], instructions: "Butter bread, add cheese and garlic, bake at 375°F until melted, sprinkle parsley.", image: "https://cdn.loveandlemons.com/wp-content/uploads/2023/01/grilled-cheese-500x500.jpg" },
        { name: "Veggie Burger", category: "lunch",ingredient: ["bun", "veggie patty", "lettuce", "tomato", "ketchup"], instructions: "Cook veggie patty, assemble on bun with lettuce, tomato, and ketchup.", image: "https://biancazapatka.com/wp-content/uploads/2020/05/veganer-bohnen-burger.jpg" },
        // Dinner
