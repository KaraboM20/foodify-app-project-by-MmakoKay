...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        ...
        { name: "Steak Sandwich", category: "dinner", ingredients: ["bread", "steak", "onion", "cheese", "pepper"], instructions: "Grill steak, sauté onions, layer on bread with cheese, season with pepper.", image: "https://www.twopeasandtheirpod.com/wp-content/uploads/2024/06/Steak-Sandwich-4348.jpg", category: "dinner" },
        { name: "Garlic Toast", category: "dinner", ingredients: ["bread", "butter", "garlic", "cheese", "parsley"], instructions: "Mix butter with garlic, spread on bread, top with cheese, bake at 375°F, add parsley.", image: "https://www.thekitchenmagpie.com/wp-content/uploads/images/2019/09/texastoast1.jpg", category: "dinner" },
        { name: "Mushroom Pizza", category: "dinner", ingredients: ["pizza dough", "tomato sauce", "mushrooms", "cheese", "basil"], instructions: "Spread sauce, add mushrooms and cheese, bake at 425°F, garnish with basil.", image: "https://www.acouplecooks.com/wp-content/uploads/2019/06/Mushroom-Pizza-with-Herbs-011.jpg", category: "dinner" },
        // Dessert
