...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        ...
        // Dessert
        { name: "Dessert Burger", ingredients: ["bun", "ice cream", "chocolate sauce", "sprinkles"], instructions: "Scoop ice cream into bun, drizzle with chocolate sauce, add sprinkles.", image: "https://www.amummytoo.co.uk/wp-content/uploads/2017/10/schar-gluten-free-apple-burger-treats-main-1.jpg" },
