...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        // Breakfast
        {name: "Breakfast Burger",  ingredients: ["bun", "egg", "bacon", "cheese", "lettuce"], instructions: "Fry egg and bacon, assemble on bun with cheese and lettuce, serve warm.", image: " https://stephenlarosa.co/wp-content/uploads/2021/07/Breakfast-Burger.blog-1-scaled.jpg" },
