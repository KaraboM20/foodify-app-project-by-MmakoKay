...
const Recipe = mongoose.model("Recipe", recipeSchema);
    ...
    if (count === 0) {
      const recipes = [
        // Breakfast
   {nam: "Breakfast Burger", category: "breakfast", "ingredients": ["bun", "egg", "bacon", "cheese", "lettuce"], "instructions": "Fry egg and bacon, assemble on bun with cheese and lettuce, serve warm.", "image": " https://stephenlarosa.co/wp-content/uploads/2021/07/Breakfast-Burger.blog-1-scaled.jpg" },
        {nam: "Breakfast Pizza", category: "breakfast", "ingredients": ["pizza dough", "egg", "sausage", "cheese", "spinach"], "instructions": "Spread dough, top with scrambled egg, sausage, cheese, and spinach, bake at 400°F for 15 mins.", "image": "https://www.skinnytaste.com/wp-content/uploads/2018/02/breakfast-pizza-1-6.jpg" },
        {nam: "Breakfast Sandwich", category: "breakfast", "ingredients": ["bread", "egg", "ham", "cheese", "butter"], "instructions": "Fry egg, layer with ham and cheese between buttered bread, grill until golden.", "image": "https://grilledcheesesocial.com/wp-content/uploads/2024/04/bagel-breakfast-sandwich-recipe-9.jpg" },
        {nam: "Breakfast Toast", category: "breakfast", "ingredients": ["bread", "avocado", "egg", "salt", "pepper"], "instructions": "Toast bread, mash avocado on top, add fried egg, season with salt and pepper.", "image": "https://www.aberdeenskitchen.com/wp-content/uploads/2019/05/Avocado-Egg-Breakfast-Toast-FI-Thumbnail-1200X1200.jpg" },
        nam: "Veggie Breakfast Pizza", category: "breakfast", "ingredients": ["pizza dough", "egg", "bell peppers", "cheese", "mushrooms"], "instructions": "Roll out dough, top with scrambled egg, veggies, and cheese, bake at 400°F for 15 mins.", "image": "https://frommybowl.com/wp-content/uploads/2017/06/Cheezy_Vegan_Breakfast_Pizza_Smoky_Tempeh_Bacon-6.jpg" },
        // Lunch
